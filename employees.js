...
const employeeOne = new Employee ('Esme', 'Tuesday mornings');
employeeOne.getScheduled();
...
const employeeTwo = new Manager ('Penny','Friday nights', ['Tom', ' Kelly', ' Sam']);
employeeTwo.addEmployee(' Lucy');
...
manager.addEmployee(['Coach', 'Nick', 'Jess']);

...
//CODE HERE
//grab second value of the TAGS array
...
const foodArr = [
    ...
    },
    {
        ...
        popularity: 8.5,
        rating: 4.3,
        tags: ['fan favorite', 'pineapple', 'ham']
    },
    {
        name: 'veggie pizza',
        price: 8.99,
        ...
        popularity: 1.5,
        rating: 1.5,
        tags: ['vegetarian', 'non meat', 'healthy']
    },
    {
        ...
        popularity: 9.5,
        rating: 4.4,
        tags: ['meat lovers', 'popular', 'classic']
    }
];
...
const filteredFood = foodArr.filter((tag) => tag.tags.includes('classic'));
...
function filterByProperty (property, number) {
    const food = foodArr.filter((x) => x[property] > number);
    return food;
}
